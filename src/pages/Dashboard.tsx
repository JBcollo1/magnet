...
const Dashboard = () => {
  ...
  const [allOrders] = useState([
    { id: 'ORD-001', customer: 'John Doe', items: '4-CUSTOM MAGNETS', total: 800, status: 'Delivered', date: '2024-12-01' },
    { id: 'ORD-002', customer: 'Jane Smith', items: '6-CUSTOM MAGNETS', total: 1200, status: 'Processing', date: '2024-12-15' },
    { id: 'ORD-003', customer: 'Mike Johnson', items: '12-CUSTOM MAGNETS', total: 2200, status: 'Shipped', date: '2024-12-10' },
    { id: 'ORD-004', customer: 'Mike Johnson', items: '9-CUSTOM MAGNETS', total: 1700, status: 'Delivered', date: '2024-11-28' }
  ]);
