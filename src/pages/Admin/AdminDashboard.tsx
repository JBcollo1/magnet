...
const AdminProduct: React.FC<AdminProductProps> = ({ allProducts, fetchAdminData }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (currentProduct) {
        await axios.put(`${import.meta.env.VITE_API_URL}/admin/products/${currentProduct.id}`, formState, { withCredentials: true });
      } else {
        await axios.post(`${import.meta.env.VITE_API_URL}/admin/products`, formState, { withCredentials: true });
      }
  ...
  const confirmDelete = async () => {
    ...
    setLoading(true);
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/admin/products/${currentProduct.id}`, { withCredentials: true });
      await fetchAdminData();
